  ...
  return (
    <div className='container'>
      ...
      <main className={styles.main}>
        ...
        <ul class="list-group">
          <li class="list-group-item">Register Your Restaurant</li>
          
          <li class="list-group-item">Customize your page</li>
          <li class="list-group-item">Update Your Menu</li>
          <li class="list-group-item">Wait for Orders</li>
        </ul>
        </div>
